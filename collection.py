...
class Collection(HydraHeadApp):
    ...
    def run(self):
        ...
        in an upward direction  across a sloping parallel line throughout the months of Aug. Furthermore, the chart depicts the price pattern's Higher Highs and Higher Lows since last year.\n
        ...
        unique wallet counts increased in the months of July and Aug, since the volume over this period of time was increased rapidly.\n
